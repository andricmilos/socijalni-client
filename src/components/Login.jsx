        ...
        <div className="landing-form">
            ...
            <form method='POST' action='http://localhost:8080/login'>
                <div className="sign-in-basic">
                    <div className="landing-form-row">
                        <div className="input-wrapper">
                            <input type="text" name="username" tabIndex={1} placeholder="Username or email" onChange={usernameChangeValue} />
                ...
                <div className="sign-in-basic">
                    <div className="landing-form-row">
                        <div className="input-wrapper">
                            <input type="password" name="password" tabIndex={2} placeholder="Password" onChange={passwordChangeValue} />
                            <div className="input-pre">
